...
public class CourseTest
{
    ...
    public void TestGetCourseDetailsStringWithBadPrice()
    {
        Course course1;
        try {
             course1 = new Course(); // Create an object with JUST a bad price
             course1.setName(GOOD_NAME);
             course1.setDepartment(GOOD_DEPARTMENT);
             course1.setNumber(GOOD_NUMBER);
        }
        ...
        try {
            assertEquals("Print details does not output the correct error string when 0.0 is given as the price. -2 marks. \n",
