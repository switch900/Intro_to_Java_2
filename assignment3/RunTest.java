...
class RunTest
{
    ...
    private static String expected = "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR + "true" + NEWLINE_CHAR; 
    private RunTest() {} 
...
"        System.out.println(b3.getTitle().equals(\"1984\"));");
        lst.add(
"        Book b4 = bookStore.getBookWrittenBy(\"aa\");        " + NEWLINE_CHAR +
